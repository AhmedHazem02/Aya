...
│   │   │
│   │   ├── Courses/
│   │   │   └── AllCourses/           # 🔜 Stub — للتيم
│   │   │
│   │   ├── Dashboard/                # 🔜 Stub — للتيم (لوحة تحكم الطالب)
│   │   │
│   │   └── Rating/                   # 🔜 Stub — للتيم (تقييم الكورس)
│   │
│   ├── routes/
...
|---|---|---|
| **All Courses** — فلترة + بحث + pagination | `/courses` | 🔴 عالية |
| **Course Details** — تفاصيل الكورس | `/courses/:id` | 🔴 عالية |
| **Student Dashboard** — إحصائيات + كورساتي | `/dashboard` | 🔴 عالية |
| **My Courses** — الكورسات المسجل بها + تقدم | `/my-courses` | 🔴 عالية |
| **Course Rating** — نجوم + مراجعة نصية | `/courses/:id/rate` | 🟡 متوسطة |
